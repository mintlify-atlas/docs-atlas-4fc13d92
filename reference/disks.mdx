---
title: "System Disk Definitions and Disk Types"
sidebarTitle: "Disks"
...
**`appearanceVariant`** — A sub-variant of the appearance theme, e.g. `"System7"` for the transitional System 7.x look, or `"Pinstripes"` for the late-90s iMac era.
