---
title: "WebAssembly Emulator Cores Used by Infinite Mac"
sidebarTitle: "Emulator Types"
description: "Capabilities and limitations of each emulator core: Mini vMac, Basilisk II, SheepShaver, DingusPPC, Previous, PearPC, and Snow."
---
...
- **Debug log**: Not supported.
- **BlueSCSI**: Not available.
- **Speed control**: Uses the `MACEMU` speed config.
...
<Tabs>
  <Tab title="MACEMU (Mini vMac, Basilisk II, SheepShaver)">
```typescript
