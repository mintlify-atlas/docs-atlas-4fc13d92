---
title: "Transferring Files Into and Out of Infinite Mac Emulator"
...
For Snow-based emulators with SCSI support, files from the library are transferred via "The Outside World" disk rather than the Downloads folder.
