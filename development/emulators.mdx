...
description: "Rebuild any of the seven WebAssembly emulator cores — Basilisk II, SheepShaver, Mini vMac, DingusPPC, Previous, PearPC, or Snow — using the Emscripten Docker image."
---
